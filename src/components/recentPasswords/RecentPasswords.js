    ...
    return (
        <div className={styles.parent}>
            ...
            <div className={styles.password1}>
                ...
                <CopyToClipboard onCopy={props.handleCopy} className={styles.copy} text={props.recent[0]}>
            ...
            <div className={styles.password2}>
                ...
                <CopyToClipboard onCopy={props.handleCopy} className={styles.copy} text={props.recent[1]}>
                    <svg width="25" height="30" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="18" height="20" fill="#1E1E1E" />
                        <rect width="1280" height="910" transform="translate(-835 -199)" fill="#0C0B10" />
                        <rect x="-435" y="-26" width="480" height="70" fill="#24232B" />
            ...
            <div className={styles.password3}>
                ...
                <CopyToClipboard onCopy={props.handleCopy} className={styles.copy} text={props.recent[2]}>
                    <svg width="25" height="30" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="18" height="20" fill="#1E1E1E" />
                        <rect width="1280" height="910" transform="translate(-835 -199)" fill="#0C0B10" />
                        <rect x="-435" y="-26" width="480" height="70" fill="#24232B" />
